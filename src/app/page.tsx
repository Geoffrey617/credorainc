  ...
  const testimonials = [
    {
      ...
      initial: "S",
      color: "bg-blue-500",
      review: "As a recent graduate with limited rental history, I was struggling to get approved for apartments in NYC. Credora made it possible for me to secure my dream apartment in Manhattan within 48 hours!"
    },
    {
      name: "Marcus Johnson",
      ...
      initial: "M",
      color: "bg-green-500",
      review: "The process was incredibly smooth and transparent. No hidden fees, fast approval, and excellent customer service. I highly recommend Credora to anyone who needs a cosigner."
    },
    {
      ...
      initial: "A",
      color: "bg-purple-500",
      review: "Moving to a new city for work was stressful, but Credora made finding an apartment so much easier. The digital process was perfect for my busy schedule."
    },
    {
      name: "David Kim",
      ...
      initial: "D",
      color: "bg-red-500",
      review: "As an international student, finding a cosigner was nearly impossible. Credora saved my academic year by helping me secure housing near campus."
    },
    {
      name: "Jessica Taylor",
      ...
      initial: "J",
      color: "bg-yellow-500",
      review: "Being self-employed made it hard to prove steady income. Credora understood my situation and got me approved for a beautiful loft in downtown Austin."
    },
    {
      name: "Michael Brown",
      role: "Teacher, Denver",
      initial: "M",
      color: "bg-indigo-500",
      review: "After a divorce, my credit took a hit. Credora gave me a second chance and helped me find a safe place for me and my kids."
    },
    {
      name: "Lisa Wang",
      ...
      initial: "L",
      color: "bg-pink-500",
      review: "The traditional rental process was taking forever. Credora's speed and efficiency helped me move to Seattle for my new job on time."
    },
    {
      ...
      initial: "R",
      color: "bg-teal-500",
      review: "I needed to relocate quickly for work. Credora's 24-hour approval process was exactly what I needed to secure housing fast."
    },
    {
      name: "Emily Davis",
      ...
      initial: "E",
      color: "bg-orange-500",
      review: "As a first-time renter, I was overwhelmed by the process. Credora's team guided me through everything and made it stress-free."
    },
    {
      name: "James Wilson",
      role: "Chef, Nashville",
      initial: "J",
      color: "bg-cyan-500",
      review: "Working multiple part-time jobs made my income look unstable on paper. Credora saw the bigger picture and got me approved."
    },
    {
      ...
      initial: "A",
      color: "bg-lime-500",
      review: "San Francisco's rental market is brutal. Credora gave me the edge I needed to compete with other applicants and land my dream apartment."
    },
    {
      name: "Kevin Lee",
    ...
    },
    {
      ...
      initial: "R",
      color: "bg-violet-500",
      review: "Even with a good job, DC's competitive market was tough. Credora's cosigning service made all the difference in securing my apartment."
    },
    {
      name: "Tyler Anderson",
      ...
      initial: "T",
      color: "bg-rose-500",
      review: "As a startup founder with fluctuating income, traditional landlords were hesitant. Credora understood my situation and made it work."
    },
    {
      name: "Samantha Moore",
    ...
    },
    {
      ...
      initial: "B",
      color: "bg-amber-500",
      review: "As a freelance musician, proving steady income was challenging. Credora's flexible approach helped me get approved for a great place in the French Quarter."
    },
    {
      name: "Nicole Adams",
      ...
      initial: "N",
      color: "bg-slate-500",
      review: "Moving for my residency program, I needed housing fast. Credora's quick turnaround time was perfect for my tight timeline."
    },
    {
    ...
    },
    {
      ...
      initial: "M",
      color: "bg-stone-500",
      review: "Credora's transparent pricing was refreshing. No hidden fees or surprises - exactly what they quoted upfront."
    },
    {
      name: "Daniel Garcia",
    ...
    },
    {
      ...
      initial: "S",
      color: "bg-blue-600",
      review: "After being turned down by several landlords, Credora gave me the confidence and backing I needed to secure my ideal apartment."
    },
    {
      name: "Anthony Young",
    ...
    },
    {
      ...
      initial: "J",
      color: "bg-purple-600",
      review: "The peace of mind knowing I had an assigned cosigner made apartment hunting so much less stressful. Thank you, Credora!"
    },
    {
      name: "Matthew Wright",
      ...
      initial: "M",
      color: "bg-yellow-600",
      review: "Moving for a postdoc position, I needed housing before starting work. Credora's service made the transition seamless."
    },
    {
      name: "Lauren Hill",
    ...
    },
    {
      ...
      initial: "R",
      color: "bg-pink-600",
      review: "Even working in finance, I needed a cosigner due to recent job change. Credora understood and delivered professional service."
    },
    {
      name: "Hannah Turner",
    ...
    },
    {
      ...
      initial: "J",
      color: "bg-orange-600",
      review: "Credora's team was patient with all my questions and made sure I understood every step of the process."
    },
    {
      ...
      initial: "A",
      color: "bg-cyan-600",
      review: "The reliability and professionalism of Credora made my landlord comfortable accepting their cosigning service immediately."
    },
    {
      ...
      initial: "T",
      color: "bg-lime-600",
      review: "Great experience from application to approval. Credora made relocating to a new state for work much easier than expected."
    }
  ];
      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              <h3 className="text-xl font-bold mb-4">Credora Inc</h3>
              <p className="text-gray-400 mb-4">
                Apartment Finder and lease cosigning service for renters nationwide.
              </p>
              <div className="flex space-x-4">
                {/* Facebook */}
                <a href="https://facebook.com/CredoraInc" className="text-gray-400 hover:text-blue-500 transition-colors" aria-label="Follow Credora Inc on Facebook">
                ...
                {/* Threads */}
                <a href="https://threads.net/@credorainc" className="text-gray-400 hover:text-slate-300 transition-colors" aria-label="Follow Credora Inc on Threads">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* Instagram */}
                <a href="https://instagram.com/credorainc" className="text-gray-400 hover:text-pink-500 transition-colors" aria-label="Follow Credora Inc on Instagram">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* TikTok */}
                <a href="https://tiktok.com/@credorainc" className="text-gray-400 hover:text-slate-300 transition-colors" aria-label="Follow Credora Inc on TikTok">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center text-gray-400 space-y-4">
              ...
              <div className="text-xs text-gray-500 max-w-4xl mx-auto">
                ...
                <p>
                  ...
                  Credora Inc acts as a cosigner service and does not guarantee apartment availability or landlord approval decisions.
                </p>
              </div>
